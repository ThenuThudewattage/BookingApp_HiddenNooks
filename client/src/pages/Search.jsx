...
export default function Search() {
    ...
    useEffect(() => {
        ...
        if(
            searchTermFromUrl || typeFromUrl || parkingFromUrl || offerFromUrl || sortFromUrl || orderFromUrl
        ) {
            setSidebarData({
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="flex gap-2 flex-wrap items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        onChange={handleChange} checked={sidebardate.type === 'rent'}/>
                        <span>Rent</span>
                    </div>

                    <div className="flex gap-2">
                        <input type="checkbox" id="sale" className="w-5" 
                        onChange={handleChange} checked={sidebardate.type === 'sale'}/>
                        <span>Sale</span>
                    </div>
                    <div className="flex gap-2">
                        <input type="checkbox" id="offer" className="w-5" 
                        onChange={handleChange} checked={sidebardate.offer}/>
                        <span>Offer</span>
                    </div>
                </div>
                <div className="flex gap-2 flex-wrap items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        onChange={handleChange} checked={sidebardate.parking}/>
                        <span>Parking</span>
                    </div>
                    <div className="flex gap-2">
                        <input type="checkbox" id="furnished" className="w-5"
                        onChange={handleChange} checked={sidebardate.furnished} />
                        <span>Furnished</span>
                    </div>
                </div>
