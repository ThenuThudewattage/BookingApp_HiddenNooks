        ...
        <form className='flex flex-col sm:flex-row gap-4'> 
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6 '> 
                    ...
                    <div className='flex items-center gap-2'>
                        <input type="number" id= "regular price" min = '1' max = '10' 
                        className='p-3 border border-gray-300 rounded-lg' required />
                    ...
                    <div className='flex items-center gap-2'>
                        <input type="number" id= "discounttPrice" min = '1' max = '10' 
                        className='p-3 border border-gray-300 rounded-lg' required />
                        <div className='flex flex-col items-center'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    <input onChange={(e)=> setFiles(e.target.files)} className='p-3 border border-gray-300
                    rounded w-full' type="file" id='images' accept='image/*'
                    multiple />
